...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__board_css__ = __webpack_require__(19);
 ...
 * click: this, color
 */
class Board extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.board';
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__deck_css__ = __webpack_require__(21);
 ...
 */
class Deck extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.deck';
    }
    ...
    constructor(root) {
        ...
        this.cards = [];
        this.realCards = [];
        const els = root.querySelectorAll(__WEBPACK_IMPORTED_MODULE_1__card_js__["a" /* default */].getRootClass());
        for (let el of els) {
            const card = new __WEBPACK_IMPORTED_MODULE_1__card_js__["a" /* default */](el);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mode_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__navbar_css__ = __webpack_require__(22);
 ...
 * none
 */
class Navbar extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.navbar';
    }
    ...
    constructor(root) {
        ...
        this.modes = []; // 3 modes
        const elems =  root.querySelectorAll(__WEBPACK_IMPORTED_MODULE_1__mode_js__["a" /* default */].getRootClass());
        for(let elem of elems){
            const mode = new __WEBPACK_IMPORTED_MODULE_1__mode_js__["a" /* default */](elem);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reset_css__ = __webpack_require__(23);
 ...
 * click: this
 */
class Reset extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.reset';
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_css__ = __webpack_require__(20);
 ...
 * click: this, color
 */
class Card extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.card';
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__board_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__deck_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reset_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__main_css__ = __webpack_require__(3);
...
class Main extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */] {
    static getRootClass() {
        return '.main';
    }
    ...
    constructor(root) {
        ...
        this.navbar = new __WEBPACK_IMPORTED_MODULE_1__navbar_js__["a" /* default */](root.querySelector('.navbar'));
        this.navbar.on('changeMode', this.handleModeChange.bind(this));

        this.deck = new __WEBPACK_IMPORTED_MODULE_3__deck_js__["a" /* default */](root.querySelector('.deck'));
        this.deck.on('wrongClick', this.handleDeckWrongClick.bind(this));
        this.deck.on('rightClick', this.handleDeckRightClick.bind(this));

        this.board = new __WEBPACK_IMPORTED_MODULE_2__board_js__["a" /* default */](root.querySelector('.board'), this.deck.getPickedColor());
        this.board.on('blink', this.handleBlink.bind(this));
        this.board.on('timeOut', this.handleTimeOut.bind(this));


        this.reset = new __WEBPACK_IMPORTED_MODULE_4__reset_js__["a" /* default */](root.querySelector('.reset'));
...
// module
exports.push([module.i, "/* mode.css */\n\n.mode{\n    text-decoration: none;\n    color: #484848;\n    text-decoration: none;\n    color: #484848;\n    padding: 0 0.5rem;\n    transition: all 0.3s;\n    -webkit-transition: all 0.3s;\n    -moz-transition: all 0.3s;\n}\n\n.mode:hover {\n    color: steelblue;\n}\n\n/*\ndiv > p: child;\ndiv + p: sibling;\n*/\n.navbar .selected { \n    border-radius: 999rem;\n    color: white;\n    font-weight: bold;\n    border-radius: 999rem;\n    color: white;\n    font-weight: bold;\n    background: steelblue;\n}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./mode.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./mode.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mode_css__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mode_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__mode_css__);
// mode.js
...
class Mode extends __WEBPACK_IMPORTED_MODULE_0__component_js__["a" /* default */]{
    static getRootClass(){
        return '.mode';
    }
